    ...
    return (
        <main className="min-h-screen text-gray-400">
            ...
            <section className="auth-right-section">
                <div className="z-10 relative lg:mt-4 lg:mb-20">
                    ...
                    <div className="flex items-center justify-between">
                        <div>
                            <cite className="auth-testimonial-author">- Aashrith</cite>
                            <p className="max-md:text-xs text-gray-100">Stocks Investor</p>
                        </div>
